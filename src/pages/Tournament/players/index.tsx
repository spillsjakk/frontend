...
class Players extends Component<PlayersProps, PlayersState> {
  ...
  removeTeam(tid: string) {
    fetchJson(
      ...
      (_) => {
        ...
        teams?.splice(
          teams?.findIndex((t) => t.team_id === tid),
          1
        );
        const info = { ...this.state.info! };
        info.teams = teams;
  ...
  changeSeedingRadio(e: ChangeEvent<HTMLInputElement>) {
    const info = { ...this.state.info! };
    info.tournament.random_seeding =
      e.target.id === "randomSeeding" && e.target.checked;
    this.setState({ info });
  }
  ...
  fideNumberBlur() {
    ...
    fetchJson(
      `/s/account/fide-autocomplete/${this.state.newAcc.fide_number}`,
      "GET",
      undefined,
      (json) => {
        ...
        newAcc.birth_date = json.birth_year
  ...
  render() {
    ...
    return (
      <>
        ...
        <div className="mt-4">
          <Translated str="seeding" />:{" "}
          <input
            type="radio"
            name="seeding"
            id="ratingSeeding"
            checked={!info.tournament.random_seeding}
            onChange={this.changeSeedingRadio}
          />
          &nbsp;
          <label htmlFor="ratingSeeding">
            <Translated str="byRating" />
          </label>
          &nbsp;
          <input
            type="radio"
          ...
          />
          &nbsp;
          <label htmlFor="randomSeeding">
            <Translated str="random" />
          </label>
          &nbsp;
          <button
            className="btn btn-primary p-3"
            id="seedingButton"
            onClick={this.updateSeeding}
          >
              ...
              <tr key={account.id}>
                ...
                <td>
                  <a
                    ...
                    onClick={() => this.removeParticipant(account.id)}
                  >
                    X
                  </a>
                </td>
            ...
            {info.teams.map((team, index) => (
              <tr key={index}>
                ...
                <td>
                  <a
                    className="btn btn-danger"
                    onClick={() => this.removeTeam(team.team_id)}
                  >
                    X
                  </a>
                </td>
        ...
        {!info.is_team_tournament && (
          <>
            <h3 className="mt-4">
              <Translated str="addParticipantsWithoutAccount" />
            </h3>
                  ...
                  <tr>
                    ...
                    <td>
                      <input
                        ...
                        id="firstNameInput"
                        name="first_name"
                        value={this.state.newAcc.first_name}
                        onChange={this.changeNewAccValue}
                        required
                      />
                    </td>
                    <td>
                      <input
                        ...
                        id="lastNameInput"
                        name="last_name"
                        value={this.state.newAcc.last_name}
                        onChange={this.changeNewAccValue}
                        required
                      />
                    </td>
                    <td>
                      <input
                        ...
                        id="fideNumberInput"
                        name="fide_number"
                        value={this.state.newAcc.fide_number}
                        onChange={this.changeNewAccValue}
                    ...
                    <td>
                      <input
                        ...
                        id="fideRatingInput"
                        name="fide_rating"
                        value={this.state.newAcc.fide_rating}
                        onChange={this.changeNewAccValue}
                      />
                    </td>
                    <td>
                      <FederationDropdown
                        ...
                        value={this.state.newAcc.fide_federation}
                        onChange={this.changeNewAccValue}
                      />
                    </td>
                    <td>
                      <input
                        ...
                        id="birthDateInput"
                        name="birth_date"
                        value={this.state.newAcc.birth_date}
                        onChange={this.changeNewAccValue}
                        required
                      />
                    </td>
